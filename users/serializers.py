        ...
        try:
            if hasattr(obj, 'profile') and obj.profile.employee:
                return {
                    ...
                    'department': obj.profile.employee.department.name
                    if obj.profile.employee.department
                    else None,
                    'job_title': obj.profile.employee.job_title.name
                    if obj.profile.employee.job_title
                    else None,
                }
        except Exception:
            pass
