...
class JobOpening(models.Model):
    ...
    job_title = models.ForeignKey(JobTitle, on_delete=models.CASCADE, related_name='job_openings',
    ...
    salary_range = models.CharField(_("Fourchette de salaire"), max_length=100, blank=True)
    ...
    created_by = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True,
                                  related_name='created_job_openings', verbose_name=_("Créé par"))
    created_at = models.DateTimeField(_("Créé le"), auto_now_add=True)
    updated_at = models.DateTimeField(_("Modifié le"), auto_now=True)
    
    # URL de la page de candidature
    application_url = models.CharField(_("URL de candidature"), max_length=255, blank=True)
...
class Candidate(models.Model):
    ...
    current_company = models.CharField(_("Entreprise actuelle"), max_length=200, blank=True)
    years_of_experience = models.PositiveSmallIntegerField(_("Années d'expérience"), default=0)
    highest_degree = models.CharField(_("Diplôme le plus élevé"), max_length=200, blank=True)
...
class Application(models.Model):
    ...
    job_opening = models.ForeignKey(JobOpening, on_delete=models.CASCADE, 
                                   related_name='applications', verbose_name=_("Offre d'emploi"))
    candidate = models.ForeignKey(Candidate, on_delete=models.CASCADE,
                                 related_name='applications', verbose_name=_("Candidat"))
    
    # CV et documents
    resume = models.FileField(_("CV"), upload_to='recruitment/resumes/%Y/%m/')
    cover_letter = models.FileField(_("Lettre de motivation"), upload_to='recruitment/cover_letters/%Y/%m/', 
    ...
    status = models.CharField(_("Statut"), max_length=30, choices=STATUS_CHOICES, default='received')
    
    # Notes et dates d'entretien
    interview_date = models.DateTimeField(_("Date d'entretien"), null=True, blank=True)
    interview_location = models.CharField(_("Lieu d'entretien"), max_length=200, blank=True)
...
class InterviewPanel(models.Model):
    ...
    job_opening = models.ForeignKey(JobOpening, on_delete=models.CASCADE,
                                   related_name='interview_panels', verbose_name=_("Offre d'emploi"))
    name = models.CharField(_("Nom du panel"), max_length=200)
    
    # Métadonnées
    created_by = models.ForeignKey(Employee, on_delete=models.SET_NULL, null=True,
                                  related_name='created_panels', verbose_name=_("Créé par"))
    created_at = models.DateTimeField(_("Créé le"), auto_now_add=True)
    updated_at = models.DateTimeField(_("Modifié le"), auto_now=True)
...
class Interviewer(models.Model):
    ...
    panel = models.ForeignKey(InterviewPanel, on_delete=models.CASCADE,
                             related_name='interviewers', verbose_name=_("Panel"))
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE,
                                related_name='interview_participations', verbose_name=_("Employé"))
...
class CandidateEvaluation(models.Model):
    ...
    application = models.ForeignKey(Application, on_delete=models.CASCADE,
                                   related_name='evaluations', verbose_name=_("Candidature"))
    interviewer = models.ForeignKey(Interviewer, on_delete=models.CASCADE,
                                   related_name='candidate_evaluations', verbose_name=_("Évaluateur"))
    ...
    general_impression = models.PositiveSmallIntegerField(_("Impression générale"), 
                                                         choices=IMPRESSION_CHOICES)
    
    # Anglais (optionnel)
    english_level = models.PositiveSmallIntegerField(_("Niveau d'anglais"), null=True, blank=True)
    ...
    evaluation_form = models.FileField(_("Fiche d'évaluation"), 
...
class CriterionScore(models.Model):
    ...
    evaluation = models.ForeignKey(CandidateEvaluation, on_delete=models.CASCADE,
                                  related_name='criterion_scores', verbose_name=_("Évaluation"))
    criterion = models.ForeignKey(EvaluationCriterion, on_delete=models.CASCADE,
                                 related_name='scores', verbose_name=_("Critère"))
...
class RecruitmentStats(models.Model):
    ...
    total_job_openings = models.PositiveIntegerField(_("Total des offres d'emploi"), default=0)
    total_applications = models.PositiveIntegerField(_("Total des candidatures"), default=0)
    applications_per_opening = models.DecimalField(_("Candidatures par offre"), 
                                                 max_digits=5, decimal_places=2, default=0)
    
    # Statistiques par phase
    preselected_applications = models.PositiveIntegerField(_("Candidatures présélectionnées"), default=0)
    interviewed_candidates = models.PositiveIntegerField(_("Candidats interviewés"), default=0)
    hired_candidates = models.PositiveIntegerField(_("Candidats embauchés"), default=0)
    
    # Taux de conversion
    preselection_rate = models.DecimalField(_("Taux de présélection (%)"), 
                                          max_digits=5, decimal_places=2, default=0)
    interview_rate = models.DecimalField(_("Taux d'entretien (%)"), 
                                       max_digits=5, decimal_places=2, default=0)
    hiring_rate = models.DecimalField(_("Taux d'embauche (%)"), 
                                    max_digits=5, decimal_places=2, default=0)
    
    # Temps moyen
    avg_time_to_hire = models.PositiveIntegerField(_("Temps moyen d'embauche (jours)"), default=0)
...
class RecruitmentNotification(models.Model):
    ...
    job_opening_id = models.PositiveIntegerField(_("ID Offre d'emploi"), null=True, blank=True)
    application_id = models.PositiveIntegerField(_("ID Candidature"), null=True, blank=True)
