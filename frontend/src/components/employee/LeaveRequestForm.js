// src/components/employee/LeaveRequestForm.js
        ...
        <Form form={form} layout="vertical" onFinish={handleSubmit} scrollToFirstError>
                ...
                <Option key={lt.id} value={lt.id}>
                  <span
                    style={{
                      ...
                      borderRadius: '50%', backgroundColor: lt.color, marginRight: 8,
                    }}
                  />
                  {lt.name}
                </Option>
          ...
          <Form.Item>
            <Space>
              ...
              <Button onClick={() => navigate('/my-space/leaves')}>Annuler</Button>
            </Space>
          </Form.Item>
        </Form>
      </Card>
