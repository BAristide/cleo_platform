...
from .models import Activity, Company, Contact, Opportunity
...
class OpportunityFilter(django_filters.FilterSet):
    ...
    closed_after = django_filters.DateFilter(
        field_name='closed_date', lookup_expr='gte'
    )
    closed_before = django_filters.DateFilter(
        field_name='closed_date', lookup_expr='lte'
    )
...
class ActivityFilter(django_filters.FilterSet):
    ...
    completed_after = django_filters.DateTimeFilter(
        field_name='completed_date', lookup_expr='gte'
    )
    completed_before = django_filters.DateTimeFilter(
        field_name='completed_date', lookup_expr='lte'
    )
    ...
    def filter_this_week(self, queryset, name, value):
        ...
        return queryset.filter(
            start_date__gte=start_datetime, start_date__lte=end_datetime
        )
