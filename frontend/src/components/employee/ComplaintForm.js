// src/components/employee/ComplaintForm.js
  ...
  return (
    <div>
      ...
      <Card style={{ maxWidth: 680 }}>
        <Alert type="info" showIcon style={{ marginBottom: 24 }} message="Confidentialité"
        ...
        <Form form={form} layout="vertical" onFinish={handleSubmit} scrollToFirstError
          ...
          <Form.Item name="description" label="Description" rules={[{ required: true, message: 'Veuillez décrire la situation.' }]}>
            <TextArea rows={6} placeholder="Décrivez la situation en détail..." />
          </Form.Item>
          <Form.Item name="is_anonymous" label="Soumettre de manière anonyme" valuePropName="checked">
          ...
          <Space>
            ...
            <Button onClick={() => navigate('/my-space/complaints')}>Annuler</Button>
          </Space>
        </Form>
      </Card>
    </div>
