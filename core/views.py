...
COUNTRY_PACKS = {
    'CI': {
        ...
        'payroll_labels': {
            ...
            'social_number_short': 'N° CNPS',
            'social_organism': 'CNPS',
    ...
    'ML': {
        ...
        'payroll_labels': {
            ...
            'social_number_short': 'N° INPS',
            'social_organism': 'INPS',
    ...
    'FR': {
        ...
        'payroll_labels': {
            ...
            'social_number_short': 'N° SS',
            'social_organism': 'URSSAF',
...
def _get_public_holidays_for_country(country_code: str) -> list:
    ...
    PUBLIC_HOLIDAYS_SN = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {'name': 'Fete de l Independance', 'date': '2024-04-04', 'is_recurring': True},
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        {'name': 'Assomption', 'date': '2024-08-15', 'is_recurring': True},
        {'name': 'Toussaint', 'date': '2024-11-01', 'is_recurring': True},
        {'name': 'Noel', 'date': '2024-12-25', 'is_recurring': True},
    ...
    PUBLIC_HOLIDAYS_ML = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {
            'name': 'Journee des Forces Armees',
            'date': '2024-01-20',
            'is_recurring': True,
        },
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        {'name': 'Fete de l Afrique', 'date': '2024-05-25', 'is_recurring': True},
        {'name': 'Fete de l Independance', 'date': '2024-09-22', 'is_recurring': True},
        {'name': 'Noel', 'date': '2024-12-25', 'is_recurring': True},
    ]
    PUBLIC_HOLIDAYS_BF = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {
            'name': 'Journee de la Revolution',
            'date': '2024-01-03',
            'is_recurring': True,
        },
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        ...
        {'name': 'Toussaint', 'date': '2024-11-01', 'is_recurring': True},
        {
            'name': 'Proclamation de la Republique',
            'date': '2024-12-11',
            'is_recurring': True,
        },
        {'name': 'Noel', 'date': '2024-12-25', 'is_recurring': True},
    ...
    PUBLIC_HOLIDAYS_TG = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {'name': 'Fete de la Liberation', 'date': '2024-01-13', 'is_recurring': True},
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        {'name': 'Fete de l Independance', 'date': '2024-04-27', 'is_recurring': True},
        {'name': 'Assomption', 'date': '2024-08-15', 'is_recurring': True},
        {'name': 'Toussaint', 'date': '2024-11-01', 'is_recurring': True},
        {'name': 'Noel', 'date': '2024-12-25', 'is_recurring': True},
    ]
    PUBLIC_HOLIDAYS_BJ = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {'name': 'Fete Nationale', 'date': '2024-08-01', 'is_recurring': True},
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        {'name': 'Assomption', 'date': '2024-08-15', 'is_recurring': True},
        {'name': 'Toussaint', 'date': '2024-11-01', 'is_recurring': True},
        {'name': 'Noel', 'date': '2024-12-25', 'is_recurring': True},
    ...
    PUBLIC_HOLIDAYS_NE = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        {'name': 'Fete de l Independance', 'date': '2024-08-03', 'is_recurring': True},
        {
            'name': 'Proclamation de la Republique',
            'date': '2024-12-18',
            'is_recurring': True,
    ...
    PUBLIC_HOLIDAYS_GN = [
        {'name': 'Nouvel An', 'date': '2024-01-01', 'is_recurring': True},
        {'name': 'Fete du Travail', 'date': '2024-05-01', 'is_recurring': True},
        {'name': 'Journee de l Armee', 'date': '2024-11-01', 'is_recurring': True},
        {'name': 'Fete de l Independance', 'date': '2024-10-02', 'is_recurring': True},
        {'name': 'Noel', 'date': '2024-12-25', 'is_recurring': True},
    ]
    HOLIDAYS_BY_COUNTRY = {
        'CI': PUBLIC_HOLIDAYS_OHADA,
        'SN': PUBLIC_HOLIDAYS_SN,
        'ML': PUBLIC_HOLIDAYS_ML,
        'BF': PUBLIC_HOLIDAYS_BF,
        'TG': PUBLIC_HOLIDAYS_TG,
        'BJ': PUBLIC_HOLIDAYS_BJ,
        'NE': PUBLIC_HOLIDAYS_NE,
        'GN': PUBLIC_HOLIDAYS_GN,
