...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'email', 'first_name', 'last_name', 'is_staff', 'get_employee', 'get_roles')
...
class ActivityLogAdmin(admin.ModelAdmin):
    list_display = ('user', 'action', 'module', 'entity_type', 'entity_id', 'ip_address', 'timestamp')
    list_filter = ('module', 'action', 'timestamp')
    search_fields = ('user__username', 'action', 'details')
    readonly_fields = ('user', 'action', 'module', 'entity_type', 'entity_id', 'details', 'ip_address', 'timestamp')
