...
class Contact(models.Model):
    ...
    title = models.CharField(
        max_length=100, blank=True, help_text='Job title or position'
    )
    ...
    source_detail = models.CharField(
        max_length=200, blank=True, help_text='Additional details about the lead source'
    )
...
class SalesStage(models.Model):
    ...
    probability = models.PositiveSmallIntegerField(
        default=0, help_text='Default probability percentage for this stage'
    )
...
class Opportunity(models.Model):
    ...
    stage = models.ForeignKey(
        SalesStage, on_delete=models.PROTECT, related_name='opportunities'
    )
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name='created_opportunities'
    )
    assigned_to = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
...
class ActivityType(models.Model):
    ...
    icon = models.CharField(
        max_length=50, blank=True, help_text="Icon name (e.g., 'phone', 'envelope')"
    )
    color = models.CharField(max_length=20, default='#3498db')  # Hex color code
...
class StageHistory(models.Model):
    ...
    to_stage = models.ForeignKey(
        SalesStage, on_delete=models.PROTECT, related_name='to_stage_history'
    )
