...
from .models import Application, CandidateEvaluation, JobOpening
...
class JobOpeningFilter(django_filters.FilterSet):
    ...
    opening_date_after = django_filters.DateFilter(
        field_name='opening_date', lookup_expr='gte'
    )
    opening_date_before = django_filters.DateFilter(
        field_name='opening_date', lookup_expr='lte'
    )
...
class ApplicationFilter(django_filters.FilterSet):
    ...
    application_date_after = django_filters.DateFilter(
        field_name='application_date', lookup_expr='gte'
    )
    application_date_before = django_filters.DateFilter(
        field_name='application_date', lookup_expr='lte'
    )
    interview_date_after = django_filters.DateFilter(
        field_name='interview_date', lookup_expr='gte'
    )
    interview_date_before = django_filters.DateFilter(
        field_name='interview_date', lookup_expr='lte'
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'candidate',
            'status',
            'application_date_after',
            'application_date_before',
            'interview_date_after',
            'interview_date_before',
        ]
...
class CandidateEvaluationFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = [
            'application',
            'interviewer',
            'evaluation_date_after',
            'evaluation_date_before',
            'general_impression',
        ]
