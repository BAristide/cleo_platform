...
class PayrollParameterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'code', 'name', 'value', 'effective_date', 'end_date', 
...
class SalaryComponentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'code', 'name', 'description', 'component_type', 'component_type_display',
                 'is_taxable', 'is_cnss_eligible', 'is_active', 'formula', 'created_at', 'updated_at']
...
class TaxBracketSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TaxBracket
        fields = ['id', 'min_amount', 'max_amount', 'rate', 'deduction', 
                 'effective_date', 'end_date', 'range_display', 'created_at', 'updated_at']
...
class EmployeePayrollSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'employee', 'employee_name', 'contract_type', 'contract_type_name',
                 'base_salary', 'hourly_rate', 'cnss_number', 'bank_account', 'bank_name',
                 'bank_swift', 'payment_method', 'payment_method_display', 'transport_allowance',
                 'meal_allowance', 'created_at', 'updated_at']
...
class PaySlipLineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PaySlipLine
        fields = ['id', 'payslip', 'component', 'component_name', 'component_type',
                 'amount', 'base_amount', 'rate', 'quantity', 'is_employer_contribution',
...
class PaySlipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PaySlip
        fields = ['id', 'payroll_run', 'period_name', 'employee', 'employee_data',
                 'number', 'worked_days', 'absence_days', 'paid_leave_days', 'unpaid_leave_days',
                 'overtime_25_hours', 'overtime_50_hours', 'overtime_100_hours',
                 'basic_salary', 'gross_salary', 'taxable_salary', 'net_salary',
                 'cnss_employee', 'cnss_employer', 'amo_employee', 'amo_employer', 'income_tax',
                 'status', 'status_display', 'is_paid', 'payment_date', 'payment_reference',
                 'pdf_file', 'notes', 'lines', 'created_at', 'updated_at']
...
class PayrollRunSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PayrollRun
        fields = ['id', 'period', 'period_name', 'name', 'description', 'department',
                 'department_name', 'status', 'status_display', 'run_date', 'calculated_date',
                 'validated_date', 'paid_date', 'created_by', 'created_by_name',
                 'validated_by', 'validated_by_name', 'notes', 'payslips_count',
                 'payslips_summary', 'created_at', 'updated_at']
...
class AdvanceSalarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'employee', 'employee_name', 'period', 'period_name',
                 'amount', 'payment_date', 'is_paid', 'notes', 'payslip',
                 'payslip_number', 'created_at', 'updated_at']
